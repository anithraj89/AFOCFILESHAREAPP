<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="ReportDownloadDetails.aspx.cs" Inherits="AFOCFILESHARE.Admin.ReportDownloadDetails" %>
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <asp:Image ID="ImgUpload1" runat="server" ImageUrl="~/Styles/css-admin/calendar.png" /></div>
                        ...
                        <div>
                            ...
                            <rsweb:ReportViewer ID="rptListDownloadDetails" runat="server" Width="80%"  Height="950px">
                            </rsweb:ReportViewer>
                        </div>
                    </div>
                </div>
