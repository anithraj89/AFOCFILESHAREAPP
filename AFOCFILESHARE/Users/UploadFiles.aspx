<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="UploadFiles.aspx.cs" Inherits="AFOCFILESHARE.Users.UploadFiles" %>
				...
				<div class="panel panel-default">
						...
						<div class="col-md-6">
							<form role="form">
								...
								<div class="form-group">
                                 <p class="help-block"> Hi User, Please select the file you need to upload <br />
                    ...
                    ControlToValidate="FileUpload1" ValidationGroup="check" ErrorMessage="File Required!"> </asp:RequiredFieldValidator>
                            ...
                            <asp:Button ID="btnsubmit" runat="server" Text="Upload"  class="btn btn-primary" 
                                    onclick="btnsubmit_Click1"  ValidationGroup="check" />
